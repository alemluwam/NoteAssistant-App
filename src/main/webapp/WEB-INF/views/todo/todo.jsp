        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                	<a href="${pageContext.request.contextPath}/todo" class="list-group-item active">ToDo List</a>
                    <a href="${pageContext.request.contextPath}/todo/add" class="list-group-item">Add New ToDo</a>
                </div>
            </div>
                ...
                <div class="col-md-15">
                    ...
                    <form class="form-inline" role="form" method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-lg" name="search" id="search" size="52" />
                        </div>
                        <div class="form-group">
                    ...
                    <div class="panel panel-warning show100">
                        ...
                        <div class="panel-body">
                            <span class="pull-right bg-danger"><b>Due:</b> 2016-10-08 | <a href="#"><b>Delete&nbsp;</b></a></span><br/>
                    ...
                    <div class="panel panel-warning show100">
                        ...
                        <div class="panel-body">
                            <span class="pull-right bg-danger"><b>Due:</b> 2016-10-07 | <a href="#"><b>Delete&nbsp;</b></a></span><br/>
