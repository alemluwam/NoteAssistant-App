        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                	<a href="${pageContext.request.contextPath}/section" class="list-group-item">Section List</a>
                    <a href="${pageContext.request.contextPath}/section/add" class="list-group-item active">Add New Section</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <form role="form" method="post" action="">
                    ...
                    <div class="well">
                        <div class="row">
                            <div class="col-md-12">
                                <span class="glyphicon glyphicon-star"></span> Add section for better organizing Note or
                                ToDo.
